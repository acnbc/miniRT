...
/*   Updated: 2026/03/21 15:18:46 by jessica          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		scalar_multiplication(t_matrix *matrix, const t_matrix *tuple, double scalar);
void		scalar_division(t_matrix *matrix, const t_matrix *tuple, double scalar);
